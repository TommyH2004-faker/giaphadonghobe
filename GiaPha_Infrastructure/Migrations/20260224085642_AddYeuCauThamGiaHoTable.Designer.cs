...
namespace GiaPha_Infrastructure.Migrations
{
    ...
    [Migration("20260224085642_AddYeuCauThamGiaHoTable")]
    partial class AddYeuCauThamGiaHoTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiaPha_Domain.Entities.TaiKhoan_Ho", b =>
                {
                    ...
                    b.Property<int>("RoleInHo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);

                    b.HasKey("TaiKhoanId", "HoId");

                    b.HasIndex("HoId");

                    b.HasIndex("TaiKhoanId");

                    b.HasIndex("TaiKhoanId", "RoleInHo");

                    b.ToTable("TaiKhoan_Hos", (string)null);
                });
            ...
            modelBuilder.Entity("GiaPha_Domain.Entities.YeuCauThamGiaHo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("UserId", "HoId", "TrangThai");

                    b.ToTable("YeuCauThamGiaHos", (string)null);
                });
            ...
            modelBuilder.Entity("GiaPha_Domain.Entities.TaiKhoan_Ho", b =>
                {
                    b.HasOne("GiaPha_Domain.Entities.Ho", "Ho")
                        .WithMany("TaiKhoan_Hos")
                        .HasForeignKey("HoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GiaPha_Domain.Entities.TaiKhoanNguoiDung", "TaiKhoan")
                        .WithMany("TaiKhoan_Hos")
            ...
            modelBuilder.Entity("GiaPha_Domain.Entities.YeuCauThamGiaHo", b =>
                {
                    ...
                    b.HasOne("GiaPha_Domain.Entities.TaiKhoanNguoiDung", "NguoiXuLy")
                        .WithMany()
                        .HasForeignKey("NguoiXuLyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GiaPha_Domain.Entities.TaiKhoanNguoiDung", "User")
                        .WithMany()
